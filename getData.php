...
if ($result->num_rows > 0) {
    while($row = $result->fetch_assoc()) {
        ...
        $owner_query = "SELECT * FROM owner WHERE owner_id = '$owner_id'";
       ...
       water_cooler, cctv, security_warden, medical_services FROM pg_facilities WHERE pg_id='$pg_id'";
        ...
        $response[] = array_merge($row,["owner" => $owner ,"address"=>$address ,"amenities" => $selected_amenities ,"price" => $price , "availability" => $avability,"images" => $image_path,
